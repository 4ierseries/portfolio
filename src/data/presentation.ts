...
const presentation: Presentation = {
  ...
  description:
      ...
      + " I build things like **Apps**, **Games**, and projects on the web like [**this site**](\"https/salmaj.me/\"). I've also competed at several **hackathons** and built things like [**this**](\"https://github.com/ssszlma/TTT_Betting\") Web3 dApp."
      ...
      + "<br><br>Check out **[/projects](\"https://salmaj.me/projects\")** or my GitHub [(@**ssszlma**)](\"https://github.com/ssszlma\") for more of my projects!",
